...
import { FolderGit2, Settings, Plus, ChevronRight, Home, Key, Settings2, MessageSquare, Book } from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        'fixed left-0 top-14 z-40 h-[calc(100vh-3.5rem)] w-64 border-r bg-background transition-transform duration-200 ease-in-out xl:translate-x-0',
          ...
          <nav className="space-y-2">
            ...
            {selectedProjectId && (
              <div className="pt-4">
                ...
                <Link
                  href={`/projects/${selectedProjectId}/glossary`}
                  className={cn(
                    'flex items-center gap-2 rounded-md px-3 py-2 text-sm transition-colors hover:bg-accent',
                    pathname === `/projects/${selectedProjectId}/glossary` && 'bg-accent font-medium'
                  )}
                >
